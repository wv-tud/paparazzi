 ...
 */
/**
 * @file "modules/calibration/accel_calib_ukf.h"
 * @author w.vlenterie
...
#ifndef ACCEL_CALIB_UKF_H
#define ACCEL_CALIB_UKF_H

#include "std.h"
#include "TRICAL.h"

// setting to request state reset
extern bool accel_calib_ukf_reset_state;
extern bool accel_calib_ukf_send_state;

extern TRICAL_instance_t accel_calib;
