...
float nav_rotorcraft_shake_throw_fall_threshold = 3.5; ///< The motors are spinning so more noise on sensor

float nav_rotorcraft_shake_throw_upside_z_threshold = 7.0;
float nav_rotorcraft_shake_throw_upside_xy_threshold = 1.5;

uint16_t nav_rotorcraft_shake_throw_shake_time = 16;
uint16_t nav_rotorcraft_shake_throw_cancel_time = 256;
uint16_t nav_rotorcraft_shake_throw_timeout_time = 256;
