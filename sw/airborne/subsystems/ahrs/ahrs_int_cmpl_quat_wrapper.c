...
/** ABI binding for Accel data.
 * Used for accel ABI messages.
 */
#ifndef AHRS_ICQ_ACCEL_ID
#define AHRS_ICQ_ACCEL_ID ABI_BROADCAST
#endif
PRINT_CONFIG_VAR(AHRS_ICQ_IMU_ID)
...
void ahrs_icq_register(void)
{
  ...
  AbiBindMsgIMU_ACCEL_INT32(AHRS_ICQ_ACCEL_ID, &accel_ev, accel_cb);
